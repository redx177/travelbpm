...
\begin{table}[H] 
	...
	\begin{tabular}{ | c | c | c | c | c | c | } 
		...
		Bonita BPM\footcite{Bonitasoft_2016-06-12} & x & x & & x & x \\ \hline
		BizTalk\footcite{BizTalk_2016-06-12} & x &  & x & x &  \\ \hline		
	\end{tabular} 
\end{table}

Von den Funktionen ist Microsoft's BizTalk die geeignetste Variante. Jedoch läuft dieses Programm nicht auf Linux und es ist nicht gratis. Die zweitbeste Wahl ist Bonita BPM von Bonitasoft, welches keine \Gls{glos:api} Anfragen mittels \Gls{glos:json} unterstützt.